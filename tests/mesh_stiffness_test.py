...
for gear_angle in gear_angles:
    ...
    gear_engagement, gear_alpha1 = gear.computeTeethEngagement(
        gear_teeth_pos, "driving", 0, +100, pinion
    )
    ...
    pinion_engagement, pinion_alpha1 = pinion.computeTeethEngagement(
        pinion_teeth_pos, "driven", 0, -100, gear
    )
